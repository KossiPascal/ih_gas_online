...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <h3 class="ml-5">{{__('messages.HISTORIQUE DES ENTREES')}}</h3>
        <div class="col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('ent.index')}}" class="btn btn-success"><i class="fa fa-info"></i> {{__('messages.Nouvelle Entree')}}</a>
            </div>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='ent/"+row.ent_num+"/edit' class='btn btn-success'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'ent_num',
                            name:'ent_num',
                            render:function (data, type, row) {
                                return "<a href='ent/"+row.ent_num+"' class='btn btn-info'><i class='fa fa-print'></i></a>"}
                        }

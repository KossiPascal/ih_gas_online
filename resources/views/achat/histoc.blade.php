                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='ach/"+row.rec_num+"/edit' class='btn btn-success'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'rec_num',
                            name:'rec_num',
                            render:function (data, type, row) {
                                return "<a href='ach/"+row.rec_num+"' class='btn btn-info'><i class='fa fa-print'></i></a>"}
                        }

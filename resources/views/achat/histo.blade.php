...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <h3 class="ml-5">{{__('messages.HISTORIQUE DES ACHATS')}}</h3>
        <div class="col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('ach.index')}}" class="btn btn-success"><i class="fa fa-plus"></i>{{__('messages.Nouvel Achat')}}</a>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('cmde.index')}}" class="btn btn-warning"><i class="fa fa-database"></i>{{__('messages.Nouvelle commande')}}</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="histo_prod">
                        ...
                        <tr class="cart_menu" style="background-color: #00b0e8">
                            ...
                            <td class="price">{{__('message.Magasin')}}</td>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='ach/"+row.reception_id+"/edit' class='btn btn-success'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'reception_id',
                            name:'reception_id',
                            render:function (data, type, row) {
                                return "<a href='ach/"+row.reception_id+"' class='btn btn-info'><i class='fa fa-print'></i></a>"}
                        }

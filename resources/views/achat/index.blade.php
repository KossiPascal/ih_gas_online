                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td width="50%">
                                                        ...
                                                        <input type="text" name="prix_achat" id="prix_achat" class="form-control" required="required" value="0"/>
                                                    </td>
                                                    <td width="50%">
                                                        <label class="control-label col-md-12">{{__('messages.Prix de vente')}} </label>
                                                        <input type="text" name="prix_vente" id="prix_vente" class="form-control" required="required" value="1.3"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="50%">
                                                        <label class="control-label col-md-12">{{__('messages.Unite')}} </label>
                                                        <input type="number" name="unite" id="unite" class="form-control"/>
                                                    </td>
                                                    <td width="50%">
                                    ...
                                    <form method="post" id="pdtform" class="form-horizontal">
                                        ...
                                        <table class="responsive-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group" id="prix_vente_group">
                                                        <label class="control-label col-md-12" >{{__('messages.Prix de vente')}} </label>
...
@section('extra-js')
    <script>
        ...
        function actualiser() {
            ach_num = document.getElementById("code").value;
        ...
        $(document).ready(function(){
            ...
            $('#add_form').on('submit', function(event){
                ...
                var ach_num = document.getElementById('code').value;
                $.ajax({
                    url:"{{ route('ach.add') }}",
                    method:"POST",
            ...
            $(document).on('click', '.editer', function(){
                var id = $(this).attr('id');
                var ach_num = document.getElementById('code').value;
                document.getElementById('hidden_code').value = ach_num;
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $('#hidden_code').val(ach_num);
                        $('#hidden_idcon').val(data.produit_reception_id);
                        $('#lot').val(data.lot);
                        $('#unite').val(data.unite);
                        $('#qte').val(data.qte);
                        $('#prix_achat').val(data.pa);
                        $('#prix_vente').val(data.pv);

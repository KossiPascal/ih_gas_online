    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <div class="col-md-12">
            <div class="col-md-6 float-left">
                <h4 class="ml-5">{{__('messages.HISTORIQUE DES VENTES')}}</h4>
            </div>

            <div class="col-md-46float-right">
        ...
        <div class="info-box mb-1">
            <div class="row input-daterange">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <button type="button" name="print" id="print" class="btn btn-success">{{__('messages.Imprimer')}}</button>
                </div>
            </div>
            <!-- /.info-box-content -->
        </div>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='vente/"+row.ven_num+"' class='btn btn-danger'><i class='fa fa-print'></i></a>"}
                        }

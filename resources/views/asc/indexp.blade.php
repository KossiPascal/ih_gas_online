    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;margin-bottom: 20px">
        <div class="col-md-12">
            ...
            <div class="col-md-4 float-right">
                <a href="{{route('vente.etat')}}" class="btn btn-danger"><i class="fa fa-list"></i> {{__('messages.ETAT FINANCIER')}}</a>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="qte" id="qte" class="form-control" value="1" required="required" onchange="verifQte()"/>

                ...
                <table id="historiques" class="table table-striped table-bordered data-table">
                    ...
                    @foreach($les_credits as $credit)
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-warning" id="{{$credit->ven_num}}">{{__('messages.Details')}}</a>
                            </td>
                            <td>
                                <a href="{{route('reg.index')}}" class="btn btn-success">{{__('messages.Regler')}}</a>
                            </td>
                        </tr>
                    @endforeach
                    <?php $count++;?>

        ...
        <div class="col-md-12 float-left">
            ...
            <div class="col-md-5 float-right">
                <div class="form-group">
                    <input type="hidden" value="1" id="mutnum"/>
                </div>
                                ...
                                <form method="post" id="addForm" class="form-horizontal">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <label class="control-label col-md-12" >{{__('messages.Quantite servie')}}: </label>
                                                    ...
                                                    <input type="hidden" name="pu" id="pu" class="form-control" required="required"/>
                                                    <input type="hidden" name="base" id="base" class="form-control" required="required"/>
                                                    <input type="hidden" name="marge" id="marge" class="form-control" value="0" readonly/>
                                                    <input type="hidden" name="taux" id="taux" class="form-control" required="required" onchange="verifTaux()"/>
                                                </div>
                                            </td>
                                        </tr>

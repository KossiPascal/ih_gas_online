    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="col-12 col-md-4 float-left">
                <a href="{{route('recsi.index')}}" class="btn btn-success"><i class="fa fa-plus"></i> {{__('messages.Recevoir Une comande')}}</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 float-left">
                <a href="{{route('recsi.histo')}}" class="btn btn-danger"><i class="fa fa-list"></i> {{__('messages.Suivi Commande')}}</a>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from_date = '', to_date = '')
            {
                $('#histo_prod').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data:'reception_si_id',
                            name:'reception_si_id',
                            render:function (data, type, row) {
                                return "<a href='recsi/"+row.reception_si_id+" class='btn btn-primary'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'reception_si_id',
                            name:'reception_si_id',
                            render:function (data, type, row) {
                                return "<a href='#' id='"+row.reception_si_id+"' class='details btn btn-info'><i class='fa fa-print'></i></a>"}
                        }
            ...
            $(document).on('click', '.details', function(){
                ...
                $('#details_rec').load('recsi.details_rec/'+cmde_num);

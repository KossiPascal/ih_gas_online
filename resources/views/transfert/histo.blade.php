    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('tr.index')}}" class="btn btn-success"><i class="fa fa-info"></i> {{__('messages.Nouveau Transfert')}}</a>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-left">
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='tr.maj/"+row.transfert_id+"' class='btn btn-success'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'transfert_id',
                            name:'transfert_id',
                            render:function (data, type, row) {
                                return "<a href='tr/"+row.transfert_id+"' class='btn btn-info'><i class='fa fa-print'></i></a>"}
                        }

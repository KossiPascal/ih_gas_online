            ...
            <tr>
                <td width="33%">
                    ...
                    <table class="table-bordered" style="width: 100%; border: 1px solid; border-color: #000000; border-radius: 0px">
                        <tr>
                            <td style="font-size: 10px;">RECU N° :<b>{{$vente->code}}</b></td>
                            <td style="font-size: 10px;">{{__{'messages.Date'}}} : {{$date_vente.' '.$vente->heure_vente}}</td>
                        </tr>
                        <tr>
                            <td style="font-size: 10px">{{__{'messages.Caissier'}}} :<b>{{Auth::user()->name}}</b></td>
                            <td style="font-size: 10px">{{__{'messages.Patient'}}} :<b>{{$vente->pat_num}}</td>
                        </tr>
                    </table>
                    ...
                    <table class="table-bordered float-right" style="width: 100%; border: 1px solid; border-color: #0b2e13; border-radius: 0px">
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.ASSURANCE'}}} :  <b>{{$vente->nom}}</b></td>
                            <td colspan="4" style="font-size:10px">{{__{'messages.MONTANT'}}}  : <b>{{number_format($vente->montant_total,'0','.',' ')}}</b> </td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.PRISE EN CHARGE'}}} : <b>{{number_format($vente->prise_en_charge,'0','.',' ')}}</b></td>
                            <td colspan="4" style="font-size:10px">{{__{'messages.NET A PAYER'}}}  : <b>{{number_format($vente->net_apayer,'0','.',' ')}}</b></td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.MONTANT RECU'}}}: <b>{{number_format($vente->montant_recu,'0','.',' ')}}</b></td>
                            <td colspan="4" style="font-size:10px">{{$texte}}  : <b>{{number_format($reste,'0','.',' ')}}</b></td>
                        </tr>
                    </table>
                    <table border="0">
                        <tr>
                            <td colspan="4" style="font-size:10px; text-align: center;font-style: italic">{{__('messages.Bonne guerison')}} / {{__('message.Stock utilise')}}: {{$magasin->mag_lib}}</td>
                        </tr>
                    </table>
                </td>
                <td width="33%">
                    ...
                    <table class="table-bordered" style="width: 100%; border: 1px solid; border-color: #000000; border-radius: 0px">
                        ...
                        <tr>
                            <td style="font-size: 10px">{{__{'messages.Caissier'}}} :<b>{{Auth::user()->name}}</b></td>
                            <td style="font-size: 10px">{{__{'messages.Patient'}}} :<b>{{$vente->nom_prenom}}</td>
                        </tr>
                    </table>

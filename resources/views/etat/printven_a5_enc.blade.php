            ...
            <tr>
                <td width="33%">
                    ...
                    <table class="table-bordered" style="width: 100%; border: 1px solid; border-color: #000000; border-radius: 0px">
                        <tr>
                            <td style="font-size: 10px;">RECU N° :<b>{{$vente->ven_num}}</b></td>
                            <td style="font-size: 10px;">{{__{'messages.Date'}}} : {{$date_vente.' '.$vente->ven_heure}}</td>
                        </tr>
                        <tr>
                    ...
                    <table class="table-bordered float-right" style="width: 100%; border: 1px solid; border-color: #0b2e13; border-radius: 0px">
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.ASSURANCE'}}} :  <b>{{$vente->mut_lib}}</b></td>
                            <td colspan="4" style="font-size:10px">{{__{'messages.MONTANT'}}}  : <b>{{number_format($vente->ven_mont,'0','.',' ')}}</b> </td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.PRISE EN CHARGE'}}} : <b>{{number_format($vente->ven_pec,'0','.',' ')}}</b></td>
                            <td colspan="4" style="font-size:10px">{{__{'messages.NET A PAYER'}}}  : <b>{{number_format($vente->net_apayer,'0','.',' ')}}</b></td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size:10px">{{__{'messages.MONTANT RECU'}}}: <b>{{number_format($vente->ven_rem,'0','.',' ')}}</b></td>
        ...
        <table>
            <tr>
                ...
                <td width="33%"><p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p><a href="{{route('vente.index')}}" class='btn btn-danger'><i class='fa fa-close'></i>{{__('messages.Terminer')}}</a></p></td>
            </tr>
        </table>
    </main>
@endsection

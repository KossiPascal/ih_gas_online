...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;margin-bottom: 20px">
        ...
        @foreach($catcon as $categorie)
            ...
            ->selectRaw('produits.libelle,produit_ventes.pu,sum(produit_ventes.qte) as qte, sum(produit_ventes.mont) as mont, sum(produit_ventes.pec) as pec, sum(produit_ventes.net) as net')
            ...
            ->groupBy('produits.libelle','produit_ventes.pu')
            ->get()}}
            ...
            <table style="width: 100%; border: 1px solid; border-radius: 10px" cellspacing="0" cellpadding="3">
                ...
                <tr style="border-radius: 15px; background-color: #E5CC75";>
                    <th style="font-size: 15px;" width="50%">{{$categorie->categorie_id}}</th>
                </tr>
            </table>
            <table style="width: 100%; border: 1px solid; border-radius: 10px" cellspacing="0" cellpadding="3">
                <thead>

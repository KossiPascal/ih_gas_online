...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;margin-bottom: 20px">
        <table>
            <tr>
                <td style="text-align: center; font-size: 15px;">ENCAISSE</td>
        ...
        <table class="table-bordered" style="width: 100%; border: 1px solid; border-color: #000000; border-radius: 0px">
            <tr>
                <td style="font-size: 10px;">RECU N° :<b>{{$vente->code}}</b>  /  Date : {{$date_vente.' '.$vente->heure_vente}}</td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                <td style="text-align: center; font-size: 15px;">{{__{'messages.MON ENCAISSE'}}}</td>
        ...
        <table class="table-bordered" style="width: 100%; border: 1px solid; border-color: #000000; border-radius: 0px">
            ...
            <tr>
                <td style="font-size: 10px">{{__{'messages.Caissier'}}} :<b>{{Auth::user()->name}}</b>/ Patient :<b>{{$vente->nom_prenom}}</td>
            </tr>
        </table>

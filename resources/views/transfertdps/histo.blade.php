    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-6 col-md-4 float-left">
                <a href="{{route('trdps.index')}}" class="btn btn-danger"><i class="fa fa-list"></i>{{__('messages.Nouveau transert')}}</a>
            </div>
    ...
    <script>
        $(document).ready(function(){
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='trdps/"+row.transfert_dps_id+" class='btn btn-primary'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'transfert_si_id',
                            name:'transfert_si_id',
                            render:function (data, type, row) {
                                return "<a href='#' id='"+row.transfert_dps_id+"' class='details btn btn-info'><i class='fa fa-print'></i></a>"}
                        }
            ...
            $(document).on('click', '.details', function(){
                ...
                $('#details_tr').load('trdps.details_tr/'+cmde_num);

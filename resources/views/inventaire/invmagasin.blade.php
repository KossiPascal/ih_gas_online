...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <div class="col-12 col-sm-12 col-md-12">
            <h5 class="ml-5">{{__('messages.INVENTAIRE PAR MAGASIN')}}</h5>
        ...
        <div class="info-box mb-1">
            <div class="row input-daterange">
                ...
                <div class="col-12 col-md-3">
                    <button type="button" name="filter" id="filter" class="btn btn-danger inline">{{__('messages.Rechercher')}}</button>
                    <button type="button" name="imprimer" id="imprimer" class="btn btn-primary inline">{{__('messages.Imprimer')}}</button>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="pdt_mag">
                        ...
                        <tr class="cart_menu">
                            ...
                            <td class="total">{{__('messages.Details')}}</td>
                        </tr>
                        </thead>
                    </table>
                </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.details', function(){
                ...
                var newWin = window.open();
                var the_url = "inv.details_mag/"+debut+"/"+fin+"/"+magasin_id+"/"+id;
                $.ajax({
                    type: "GET", url: the_url, data: {},
                    success: function(data){
                        newWin.document.write(data);;

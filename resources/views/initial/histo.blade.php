    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <div class="col-12 col-sm-12 col-md-12 float-left">
            <div class="col-12 col-md-8 float-left">
                <h3 class="ml-5">{{__('messages.HISTORIQUES DES INITIALISATIONS')}}</h3>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-right">
                <a href="{{route('ini.index')}}" class="btn btn-warning"><i class="fa fa-plus"></i> {{__('messages.Initialisation')}}</a>
            </div>
        </div>
        <br>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render:function (data, type, row) {
                                return "<a href='ini/"+row.ini_num+"/edit' class='btn btn-success'><i class='fa fa-edit'></i></a>"}
                        },
                        {
                            data:'ini_num',
                            name:'ini_num',
                            render:function (data, type, row) {
                                return "<a href='ini/"+row.ini_num+"' class='btn btn-info'><i class='fa fa-print'></i></a>"}
                        }

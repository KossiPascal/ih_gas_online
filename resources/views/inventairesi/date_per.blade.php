    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            ...
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('invsi.etatglobal')}}" class="btn btn-success"> {{__('messages.Etat du stock global')}}</a>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('invsi.centre')}}" class="btn btn-warning">{{__('messages.Etat du stock par centre')}}</a>
            </div>
            ...
            <div class="table-responsive">
                <table id="liste_produit" class="table table-striped table-bordered data-table">
                    ...
                    <tr>
                        ...
                        <th>{{__('messages.Perime depuis(Mois)')}}</th>

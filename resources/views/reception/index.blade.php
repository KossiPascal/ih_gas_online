    ...
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;margin-bottom: 20px">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            ...
            <div class="col-12 col-md-4 float-left">
                <a href="{{route('rec.index')}}" class="btn btn-success"><i class="fa fa-plus"></i>{{__('messages.Nouvelle Reception')}}</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 float-left">
                <a href="{{route('rec.histo')}}" class="btn btn-danger"><i class="fa fa-info"></i>{{__('messages.Historique des receptions')}}</a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 float-right">
                <a href="{{route('cmde.index')}}" class="btn btn-warning"><i class="fa fa-check"></i> {{__('messages.Nouvelle commande')}}</a>
            </div>
        </div>
                ...
                <div class="contour_div">
                    <div class="contour_table">
                        ...
                        <tr class="cart_menu" style="background-color: rgba(202,217,52,0.48)">
                            ...
                            <td class="price">{{__('messages.Qte')}}</td>
                            <td class="price">{{__('messages.Unite')}}</td>
                            <td class="price">{{__('messages.Expire')}}</td>
                            <td colspan="2"></td>
                        </tr>
                        </table>
                    </div>
    ...
    <script>
        function commande() {
            $.ajax({
                ...
                {
                    $('#commande_id').empty();
                    $('#commande_id').append('<option id="0"  value="0">- {{__('messages.Choisir une commande/Date')}} -</option>');

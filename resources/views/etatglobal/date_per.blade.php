...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        ...
        <div class="col-12 col-sm-12 col-md-12">
            ...
            <a href="{{route('eg.stockglobal')}}" class="btn btn-dark"><i class="fa fa-file-export"></i> Etat du stock global </a>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-left">
                <a href="{{route('eg.etatdps')}}" class="btn btn-warning">Etat du stock par DPS</a>
            </div>
            <div class="col-12 col-sm-4 col-md-4 float-right">
                <a href="{{route('eg.etatcentre')}}" class="btn btn-danger"><i class="fa fa-file-export"></i> Etat du stock par centre </a>
            </div>
        </div>
        <br>
        <div class="info-box">

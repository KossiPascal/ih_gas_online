...
@section('content')
    <main class="col-sm-12 ml-sm-auto col-md-12 pt-0" style="text-decoration: none; margin-top: 5px;">
        <div class="col-12 col-sm-12 col-md-12">
            <h5 class="ml-5">INVENTAIRE GLOBAL</h5>
        ...
        <div class="info-box mb-1">
            <div class="row input-daterange">
                ...
                <div class="col-12 col-md-6">
                    <button type="button" name="filter" id="filter" class="btn btn-warning">Rechercher</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5 align="center" style="margin:0;">Etes vous sure d annuler cette commande?</h5>
                    </div>
